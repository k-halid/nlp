...
_URL = "https://drive.google.com/uc?export=download&id=1Etr9z-eSkeELQIYGLEYrcLiK9iO8y8eF"

_DOCUMENT = "document"
_SUMMARY = "summary"


class ArabicEnglish(nlp.GeneratorBasedBuilder):
    """Multi-News dataset."""
    ...
    def _split_generators(self, dl_manager):
        ...
        extract_path = os.path.join(dl_manager.download_and_extract(_URL), "ArabicEnglish")
        return [
